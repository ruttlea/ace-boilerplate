...
const Panel = styled.div`
  h1 {
    ...
    background-color: ${({ theme }: Theme) => `${theme.panel.header.backgroundColor}`};
    color: ${({ theme }: Theme) => `${theme.panel.header.textColor}`};
    padding: 16px;
    margin: 0px;
  }
  .body {
    padding: 16px;
    border: ${({ theme }: Theme) => `1px solid ${theme.panel.body.borderColor}`};
  }
`;
